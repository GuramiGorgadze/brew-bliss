...
function InstagramPromo() {
  const instagramImages = [
    instagram01, instagram02, instagram03, instagram04,
    instagram05, instagram06, instagram07, instagram08,
  ];
  ...
  return (
    <div className="instagram-promo">
      {instagramImages.map((img, index) => (
        <a key={index} href="https://www.instagram.com/" target="_blank" rel="noreferrer">
      ...
      <div className="instagram-promo__viewport laptop" ref={emblaRef}>
        <div className="instagram-promo__container">
          {instagramImages.map((img, index) => (
            <div className="instagram-promo__slide" key={index}>
              <img
                src={img}
                alt={`instagram-${index}`}
