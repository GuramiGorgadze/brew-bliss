  ...
  return (
    <>
      <nav className='navbar'>
        <div className="navbar__hamburger" onClick={() => setMenuOpen(true)}>
        ...
        <div className="navbar__nav">
          <ul>
            ...
            <li className='navbar__nav-item'><Link to="/contact">CONTACT</Link></li>
            <li className='navbar__nav-item'><Link to="/">PAGES</Link></li>
          </ul>
        </div>

        <div className="navbar__actions">
          <button className='navbar__mobile-hidden' onClick={() => setSearchOpen(true)}>
            <img src={searchIcon} alt="" draggable="false" />
          </button>
          <button className='navbar__mobile-hidden'>
            <Link to="/account"><img src={profileIcon} alt="" draggable="false" /></Link>
          </button>
      ...
      {menuOpen && (
        <>
          ...
          <div className={clsx('drawer', { 'drawer--closing': menuClosing })}>
            <button className="drawer__close" onClick={closeMenu}>Close <i class="bi bi-x-lg"></i></button>
            ...
            <div className="drawer__links">
              <Link onClick={closeMenu} to="/login"><div className="drawer__link"><i class="bi bi-people"></i> Account</div></Link>
              <div className="drawer__divider"></div>
              <Link onClick={closeMenu} to="/"><div className="drawer__link">Home</div></Link>
              <div className="drawer__divider"></div>
              <Link onClick={closeMenu} to="/products"><div className="drawer__link">Products</div></Link>
              <div className="drawer__divider"></div>
              <Link onClick={closeMenu} to="/"><div className="drawer__link">Wishlist (0)</div></Link>
              <div className="drawer__divider"></div>
              <Link onClick={closeMenu} to="/about"><div className="drawer__link">About Us</div></Link>
              <div className="drawer__divider"></div>
              <Link onClick={closeMenu} to="/contact"><div className="drawer__link">Contact Us</div></Link>
              <div className="drawer__divider"></div>
            </div>
          </div>
        </>
